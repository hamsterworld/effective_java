...
public class NutritionFacts implements Serializable {
    ...
    /**
     *
     *  그렇다면 boolean 은 어떻게해야
     *  자바빈 규약에 맞는 getter,setter 를 만들수있을까?
     *  boolean 만 특별하게
     *  isHealthy 로 만들어준다.
     *
     *  이것이 자바빈즈 규약이다.
     ...
     *  자바빈즈규약에 맞게 사용할수있다.
     *
     *  결론 getter,setter 이런 규약들(자바빈즈)이 있어야
     ...
     *  인스턴스를만들기편하기때문이다.
     *
     *  Serializable 를 구현하라고 되어있다.
     *  직렬화를해서 데이터를 보관해놧다가
     *  다시 데이터를 꺼내쓸수있기대문이다.(역직렬화)
     *  직렬화에대해서 조금만더 찾아볼것
     *
     *  json 변환,mode l담기,jpa 등등
     *  객체들의 필드에 접근하는 일반적인 방법이 필요하다
     *  그래서 getter,setter 같은 자바빈즈규약을 준수해야한다.
     *
     */
