...
public class HashTable implements Cloneable {
    ...
    private static class Entry {
        ...
        //재귀적인 호출은 stackoverflow 의 위험이 있다.
...
//    //하위클래스에서 재정의가 가능하도록 만들지말것.
//    protected Entry[] createNewBuckets() {
//    }
    // 그이유는 하위클래스에서 오버라이딩하면 동작이 바뀔수있다.
    // 객체를 만드는 과정에 끼여드는거라서 위험하다.
    // 그래서 굳이 만들거면 오버라이딩못하게막거나 해야한다.
