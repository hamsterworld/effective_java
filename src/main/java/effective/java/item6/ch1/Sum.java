...
public class Sum {
    private static long sum(){
        ...
        for (long i = 0; i <=Integer.MAX_VALUE; i++){
            //기본타입을 래퍼타입으로 변경할때
            //auto boxing이 자동으로 일어난다.
            //반대로 래퍼타입에서 기본타입으로 변경될때
            //unboxing이 일어난다.
            //불필요하게 auto boxing이일어난다면? 아래처럼
            sum += i;
        }
        return sum;
    }
